function playerCollisionCheck(){
  ...
  var player2 = players[1];
    ...
    if(Math.abs(distanceY) <= player1.height/2 && Math.abs(distanceY) >= (player1.height/2)-20 && distanceY > 0 && Math.abs(Math.floor(distanceX)) < player1.width/2 && player1.velocityY > 0 && !player2.dead && !player1.stunned){
    ...
    if(Math.abs(distanceY) <= player1.height/2 && Math.abs(distanceY) >= (player1.height/2)-20 && distanceY < 0 && Math.abs(Math.floor(distanceX)) < player1.width/2 && player2.velocityY > 0 && !player1.dead && !player2.stunned){
