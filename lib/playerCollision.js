function playerCollisionCheck(players){
  ...
  // if(checkX < 0){
    ...
    if(Math.abs(distanceY) <= player1.height/2 && Math.abs(distanceY) >= (player1.height/2)-20 && distanceY > 0 && Math.abs(Math.floor(distanceX)) < player1.width/2 && player1.jumping && player1.velocityY > 0){
      alert("player1 wins!");
    }

    if(Math.abs(distanceY) <= player1.height/2 && Math.abs(distanceY) >= (player1.height/2)-20 && distanceY < 0 && Math.abs(Math.floor(distanceX)) < player1.width/2-5 && player2.jumping && player2.velocityY > 0){
      alert("player2 wins!");
    }
