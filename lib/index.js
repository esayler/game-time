...
window.onload = function() {
  ...
  function init() {
    ...
    platforms.push(new Platform({ fillStyle: 'rgba(255,152,0,1)', bg: bg, x:  520, y: 180, width:  400, height: 20, passThrough: true }));
    platforms.push(new Platform({ fillStyle: 'rgba(0,150,136,1)', bg: bg, x:  165, y: 315, width:  220, height: 20, passThrough: true }));
    platforms.push(new Platform({ fillStyle: 'rgba(158,158,158,1)', bg: bg, x:  475, y: 425, width:  325, height: 20, passThrough: true }));
    platforms.push(new Platform({ fillStyle: 'rgba(233,30,99,1)', bg: bg, x:    0, y: 214, width:  95, height: 20, passThrough: true }));
    ...
    // platforms.push(new Platform({ fillStyle: 'rgba(96,125,139,1)', bg: bg, x:  328,75: 532, width:   110, height: 40, passThrough: false }));
    ...
    platforms.push(new Platform({ fillStyle: 'rgba(3,169,244,1)', bg: bg, x:  688, y: 140, width:   36, height: 40, passThrough: true }));
