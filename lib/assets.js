...
// platforms.push(new Platform(-100, 580, 1450, 70, true));
  ...
  // platforms.push(new Platform(0, 400, 85, 40, true));
    ...
    //Desert Map
    platforms.push(new Platform({ fillStyle : 'rgba(63,81,181,1)', bgContext  : (bg.ctxt), x: -100, y: 580, width: 352, height  : 70, passThrough: false }));
    platforms.push(new Platform({ fillStyle : 'rgba(63,81,181,1)', bgContext  : (bg.ctxt), x: 499, y: 580, width: 250, height  : 70, passThrough: false }));
    platforms.push(new Platform({ fillStyle : 'rgba(63,81,181,1)', bgContext  : (bg.ctxt), x: 999, y: 580, width: 352, height  : 70, passThrough: false }));
    platforms.push(new Platform({ fillStyle : 'rgba(63,81,181,1)', bgContext  : (bg.ctxt), x: 213, y: 420, width: 312, height  : 40, passThrough: true }));
    platforms.push(new Platform({ fillStyle : 'rgba(63,81,181,1)', bgContext  : (bg.ctxt), x: 724, y: 420, width: 312, height  : 40, passThrough: true }));
    platforms.push(new Platform({ fillStyle : 'rgba(63,81,181,1)', bgContext  : (bg.ctxt), x: 403, y: 260, width: 442, height  : 40, passThrough: true }));
    platforms.push(new Platform({ fillStyle : 'rgba(63,81,181,1)', bgContext  : (bg.ctxt), x: -100, y: 100, width: 250, height  : 40, passThrough: true }));
    ...
    // platform.push(new Platform(-100, 580, 352, 70, false));
    // platform.push(new Platform(499, 580, 250, 70, false));
    // platform.push(new Platform(999, 580, 352, 70, false));
    // platform.push(new Platform(213, 393, 821, 40, true));
    // platform.push(new Platform(213, 420, 312, 40, true));
    // platform.push(new Platform(724, 420, 312, 40, true));
    // platform.push(new Platform(403, 260, 442, 40, true));
    // platform.push(new Platform(-100, 100, 250, 40, true));
    // platform.push(new Platform(1100, 100, 250, 40, true));
